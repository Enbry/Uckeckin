...
describe('User Model Unit Tests:', function () {
  ...
  describe('User Password Validation Tests', function() {
    ...
    it('should not allow a less than 10 characters long - "P@$$w0rd!"', function (done) {
      ...
      _user1.validate(function (err) {
        err.errors.password.message.should.equal('Le mot de passe doit contenir au moins une majuscule.');
        done();
      });
    });

    it('should not allow a greater than 128 caractères.', function (done) {
      var _user1 = new User(user1);
    ...
    it('should not allow more than 3 or more repeating characters - "P@$$w0rd!!!"', function (done) {
      ...
      _user1.validate(function (err) {
        err.errors.password.message.should.equal('Le mot de passe ne doit pas contenir plus de 2 caractères identiques consécutifs.');
        done();
      });
    });
    ...
    it('should not allow a password with less than one number - "P@$$word!!"', function (done) {
      ...
      _user1.validate(function (err) {
        err.errors.password.message.should.equal('Le mot de passe doit contenir au moins un nombre.');
        done();
      });
    });
    ...
    it('should not allow a password with less than one special character - "Passw0rdss"', function (done) {
      ...
      _user1.validate(function (err) {
        err.errors.password.message.should.equal('Le mot de passe doit contenir au moins un caractère spécial.');
        done();
      });
    });
  });
