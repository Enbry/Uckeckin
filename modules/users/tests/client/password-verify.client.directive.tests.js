...
(function() {
  ...
  describe('PasswordVerifyDirective', function() {
    ...
    function compileDirective(template) {
      ...
      if (!template) template = '<input type="password" id="newPassword" name="newPassword" class="form-control" ng-model="passwordMock.newPassword" placeholder="New Password" autocomplete="new-password" popover="{{popoverMsg}}" popover-trigger="focus" popover-placement="top" required>' +
