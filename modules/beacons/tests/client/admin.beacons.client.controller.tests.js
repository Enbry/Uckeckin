(function () {
  ...
  describe('Beacons Admin Controller Tests', function () {
    // Initialize global variables
    var BeaconsAdminController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (BeaconsService) {
        ...
        expect($state.go).toHaveBeenCalledWith('admin.beacons.list');
      }));
